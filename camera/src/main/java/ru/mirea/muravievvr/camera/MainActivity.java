package ru.mirea.muravievvr.camera;
...
import ru.mirea.muravievvr.camera.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.imageView2.setOnClickListener((View.OnClickListener) v -> {
